...
C     
C     Process: d d~ > mur- mur+ WEIGHTED<=2 @1
C     Process: s s~ > mur- mur+ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
        IF(mdl_Wsl5.ne.0d0) fk_mdl_Wsl5 = SIGN(MAX(ABS(mdl_Wsl5),
     $    ABS(mdl_Msl5*small_width_treatment)), mdl_Wsl5)
      endif
      AMP(:,:) = (0d0,0d0)
      ...
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,FK_ZERO,W(1,7))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,FK_ZERO,W(1,8))  !  count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_363, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_922,GC_923,MDL_MZ,FK_MDL_WZ,W(1,9))
     $  !  count 1
      CALL FFV2_5_3(W(1,2),W(1,3),GC_922,GC_923,MDL_MZ,FK_MDL_WZ,W(1,10)
     $)  !  count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_929, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
