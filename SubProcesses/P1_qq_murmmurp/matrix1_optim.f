...
C     
C     Process: u u~ > mur- mur+ WEIGHTED<=2 @1
C     Process: c c~ > mur- mur+ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_921,GC_924,MDL_MZ,FK_MDL_WZ,W(1,9))
     $  !  count 1
      CALL FFV2_5_3(W(1,2),W(1,3),GC_921,GC_924,MDL_MZ,FK_MDL_WZ,W(1,10)
     $)  !  count 1
